...
<div class="app-heading-container app-heading-bordered bottom">
    <ul class="breadcrumb">
        ...
        <li class="active">Detail Data Koordinator</li>
    </ul>
</div>
                            ...
                            <div class="col-md-9 col-xs-12">
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th colspan="2">{{$detail->namazona}}</th>
                                    </tr>
                                    <tr>
                                        <th colspan="4" style="text-align: center;">DETAIL ZONA</th>
                                    </tr>
                                    <tr>
                                        <td colspan="2" style="text-align: center;">Kecamatan</td>
                                        <td colspan="2" style="text-align: center;">Gampong</td>
                                    </tr>
                                    @foreach($zona as $zon)
                                    <tr>
                                        <th colspan="2">{{$zon->namakec}}</th>
