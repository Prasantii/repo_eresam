    ...
    <div class="container">
        <div class="block block-condensed">
            <div class="app-heading app-heading-small">
                <div class="title">
                    <h2>TAMBAH wajib_retribusi</h2>
                    <p>Manajement Data wajib_retribusi</p>
                </div>
            </div>
                               ...
                               <th id="jenis_id">
                                    <select id="jenis_id" name="jenis_id" class="bs-select" data-live-search="true" style="width: 100%">
                                        @foreach($jenis as $men)
                                            <option value="{{ $men->id }}">{{ $men->nama }} - Luas: {{ $men->luas }} - Tarif Kota:{{ $men->tarif_kota }} - Tarif Gampong:{{ $men->tarif_gampong }}</option>
                                          @endforeach
                                    </select>
                                ...
                                <div class="app-radio success inline"> 
                                    <label><input type="radio" name="kota" value="kota" > Kota?<span></span></label> 
                                </div> 
                                <div class="app-radio success inline"> 
