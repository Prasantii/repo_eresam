...
class PetugasTransformer extends TransformerAbstract
{
    ...
    public function transform(Petugas $petugas)
    {
        ...
        $data = DB::table('petugas as a')
                ->select('a.id', 'a.id_koordinator','a.nik','a.nama','a.hp','a.username','a.email','a.image','a.created_at','a.email_verify','a.token','a.token_expiry','a.updated_at','a.is_active','b.nama as namakoordinator','c.nama as namazona','c.id as idzona')
