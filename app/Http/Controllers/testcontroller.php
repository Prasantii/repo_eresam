...
public function index(){
	...
	//$data_wr = WajibRetribusi::all();
	//return view ('test1',compact($data_wr));

	//$data = ['wr'=>$this->Tagihan->AllData(),];
	//return view('/test1',$data);

		$dat = DB::table('detail_trs_wr')->paginate(10);
		return view('test1',['detail_trs_wr'=> $dat]);
    }

public function cari(Request $request){
	$cari = $request->cari;
	$dat = DB::table('wajib_retribusi')
    ...
    public function TagihanWr(Request $request){
    	...
    	return view('/test')->with(["page" => "Data Tagihan Wr"]);
    }
    ...
    public function TagihanWrKeseluruhan(Request $request,$id){
      ...
      return view('/test',compact('war'))->with(["page" => "Data test"]);

    }
    public function test(Request $request, $id){
        $coba = WajibRetribusi::where('id',decrypt($id))->first;
        return view('test',compact('coba'))->with(["page" => "coba test"]);
    }
