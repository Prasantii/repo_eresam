...
class WajibRetribusiController extends Controller
{
   public function getHash($password){
    ...
    public function data_WajibRetribusi(Request $request)
    {
        ...
        $totalData = WajibRetribusi::where('kota',1)->count();
        ...
        if (empty($request->input('search.value'))) {
            $services = DB::table('wajib_retribusi as a')
                ...
                ->whereRaw('a.gampong = 0 AND a.kota = 1')
                ->offset($start)
                ->limit($limit)
                ->orderBy($order, $dir)
                ->get();
    ...
    public function data_WajibRetribusigampong(Request $request)
    {
        ...
        $totalData = WajibRetribusi::where('gampong',1)->count();
        ...
        if (empty($request->input('search.value'))) {
            $services = DB::table('wajib_retribusi as a')
                ...
                ->leftJoin('villages as c','a.villages_id','=','c.id')
                ->leftJoin('jenis_retribusi as d','a.jenis_id','=','d.id')
                ->whereRaw('a.gampong = 1 AND a.kota = 0')
                ->offset($start)
                ->limit($limit)
                ->orderBy($order, $dir)
                ->get();
    ...
    public function data_WajibRetribusinotverifikasi(Request $request)
    {
        ...
        $totalData = WajibRetribusi::whereRaw('gampong = 0 AND kota = 0')->count();
        ...
        if (empty($request->input('search.value'))) {
            $services = DB::table('wajib_retribusi as a')
                ...
                ->leftJoin('villages as c','a.villages_id','=','c.id')
                ->leftJoin('jenis_retribusi as d','a.jenis_id','=','d.id')
                ->whereRaw('a.gampong = 0 AND a.kota = 0')
                ->offset($start)
                ->limit($limit)
                ->orderBy($order, $dir)
                ->get();
