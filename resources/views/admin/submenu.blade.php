	    ...
	    <div class="col-md-12">
	        <div class="panel panel-default">
	            <div class="panel-heading">
	                <h3 class="panel-title"><b>Sub Menu Management</b></h3>
               ...
               <form id="input-sport" method="POST" action="" enctype="multipart/form-data" >
                ...
                <input type="hidden" name="id" id="id">
                    <div class="form-group">
                        ...
                        <select name="menu_id" id="menu_id" class="bs-select" data-live-search="true" >
                            <option id="hidden" value="">----SILAHKAN PILIH MENU----</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="title" name="title" class="form-control"  placeholder="Title Menu" >
                    ...
                    <div class="form-group">
                        <label>Icon</label>
                        <select name="icon" id="icon" class="form-control" data-live-search="true" style="font-weight: 900;font-size: 16px;">
                    ...
                    <div class="app-checkbox success inline"> 
                        <label><input type="checkbox" name="is_active" value="1"> Active<span></span></label> 
                    </div>
            ...
            <div class="modal-body">
               <form id="edit-sponsor" method="POST" action="" enctype="multipart/form-data" >
                ...
                <input type="hidden" name="idbr" id="idbr">
                    <div class="form-group">
                        <label>Menu Name</label>
                        <select name="menu_idedit" id="menu_idedit" class="bs-select" data-live-search="true" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="titleedit" name="titleedit" class="form-control"  placeholder="Title Menu" >
...
<script type="text/javascript">
       ...
       table = $('#sponsor').DataTable({
            ...
            "columns": [
				...
				return '<div class="text">\n\
                            ...
                            <button class="btn btn-default popover-hover delete_btn" a="'+data['id']+'" b="'+data['title']+'" data-container="body" data-toggle="tooltip" data-placement="left" data-content="Hapus"><i class="fa fa-remove"></i></button>\n\
						</div>';
			} }
    ...
    function processInfo(info) {
     ...
     $('#input-sport').validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ url('/menu/tambahsubmenuaksi') }}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    xhr: function() {
                    ...
                    success: function (result) {
                        if(result['status'] == 'success')
                        {
                            ...
                            window.location.href = '{{url('/menu/submenu')}}';
                        }
                        else
                        {
                            new Noty({
    ...
    $(document).on("click", ".edit_modal", function (){
        ...
        $.get('{{ url("/menu/editsubmenuview")}}' + '/' + id, function (data) {
            $('#idbr').val(data.data.id);
            $("#menu_idedit").empty();
            $('#menu_idedit').append(data.sbb).selectpicker('refresh');
