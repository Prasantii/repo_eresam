...
<head>
  ...
  <title>Data Wajib Retribusi yang Belum diverifikasi</title>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Wajib Retribusi yang Belum diverifikasi</h3>
                <br>
                <br>
              </div>
