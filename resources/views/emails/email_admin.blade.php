                                ...
                                <td class="content-wrap aligncenter" colspan="2" style="background: #efefef">
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                          ...
                                          <div style="padding: 10px;font-size:15px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:left;">Kami mendapat permintaan untuk mereset kata sandi Anda.
                                          </div>
      									
                                          <br>
                                          
                                          <div style="padding: 10px;font-size:15px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:left;">Klik Link Berikut untuk mereset password anda ! <strong style="font-size:15px;">{{ $mail_body['emailreset'] }}</strong>
                                          </div>
                        									<div style="padding: 10px;font-size:15px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:left;">Jika Anda tidak meminta pengaturan ulang kata sandi, silakan hubungi Kami sesegera mungkin ..
                                                            </div>
                        									
                        									
                        									<br><br>
                        									
                        									<div style="padding: 0px 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;color:#545454;text-align:left;">SIMAUN - Sistem Manajemen ASN Untuk Negeri
                                    </div>
                                        </tr>
                                        <tr>
